...
export function BongoCat() {
  ...
  useEffect(() => {
    ...
    notes.forEach((note) => {
      ...
      if (parent) {
        parent.appendChild(note.cloneNode(true));
        parent.appendChild(note.cloneNode(true));
      }
    });
    ...
    const green = style.getPropertyValue("--bongo-green") || "#a5ea9b";
    const pink = style.getPropertyValue("--bongo-pink") || "#ff61d8";
    const blue = style.getPropertyValue("--bongo-blue") || "#569cfa";
    const orange = style.getPropertyValue("--bongo-orange") || "#ffcc81";
    const cyan = style.getPropertyValue("--bongo-cyan") || "#7ed1e2";
    ...
    const terminalLines = containerRef.current.querySelectorAll(s(".terminal-code line"));
    gsap.fromTo(
      terminalLines,
      { opacity: 0 },
      {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="bongo-cat-container" ref={containerRef}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.55 354.91" className="bongo-cat-svg">
        <g id="bongo-cat">
          <g className="head">
      ...
      <a
        href="https://codepen.io/carolineartz/pen/qBOEzQa"
        target="_blank"
        rel="noopener noreferrer"
        className="mt-2 text-xs text-muted-foreground hover:text-foreground transition-colors"
      >
        Original by @carolineartz
      </a>
    </div>
  );
}
